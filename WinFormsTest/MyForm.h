...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox1->Text = L"Òåñòîâàÿ";
			...
			this->label2->Text = L"Êîíòðîëü ëîê. ïîãðåøíîñòè";
			// 
			// textBox1
			// 
			...
			this->label4->Text = L"Íà÷àëüíûé øàã";
			// 
			// groupBox2
			// 
			...
			this->tabControl1->Size = System::Drawing::Size(989, 136);
			...
			this->tabPage1->Size = System::Drawing::Size(981, 110);
			...
			this->richTextBox2->Size = System::Drawing::Size(969, 98);
			...
			this->tabPage2->Size = System::Drawing::Size(981, 110);
			...
			this->tabPage3->Size = System::Drawing::Size(981, 110);
			...
			this->label5->Text = L"Òî÷íîñòü âûõîäà íà ãðàíèöó";
			// 
			// textBox4
			// 
			...
			// 
			this->dataGridViewTextBoxColumn6->HeaderText = L"ÎËÏ";
			...
			// 
			this->dataGridViewTextBoxColumn14->HeaderText = L"ÎËÏ";
...
#define PI 3.14159265 
	...
	private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		chart2->Hide();
		chart3->Hide();
		richTextBox1->Text = "Òåñòîâàÿ çàäà÷à:\n"+"du/dx = -1 * 3u/2\n" + "U(0) = U0";
		...
		switch (comboBox1->SelectedIndex)
		{
			case 0:
			{
				...
				if (checkBox1->Checked)
				{
					...
					richTextBox2->Text += "×èñëî óäâîåíèé: " + udvoenie + "\n";
					richTextBox2->Text += "×èñëî äåëåíèé: " + delenie + "\n";
					richTextBox2->Text += "Ìàêñèìàëüíûé øàã: " + hmax + ", ïðè x = " + xmax + "\n";
					richTextBox2->Text += "Ìèíèìàëüíûé øàã: " + hmin + ", ïðè x = " + xmin + "\n";
				};
				...
				if (checkBox2->Checked)
				{
					...
					richTextBox3->Text += "×èñëî óäâîåíèé: " + udvoenie + "\n";
					richTextBox3->Text += "×èñëî äåëåíèé: " + delenie + "\n";
					richTextBox3->Text += "Ìàêñèìàëüíûé øàã: " + hmax + ", ïðè x = " + xmax + "\n";
					richTextBox3->Text += "Ìèíèìàëüíûé øàã: " + hmin + ", ïðè x = " + xmin + "\n";
				};
			...
			case 1:
			{
				...
				if (checkBox3->Checked)
				{
					...
					richTextBox4->Text += "×èñëî óäâîåíèé: " + udvoenie + "\n";
					richTextBox4->Text += "×èñëî äåëåíèé: " + delenie + "\n";
					richTextBox4->Text += "Ìàêñèìàëüíûé øàã: " + hmax + ", ïðè x = " + xmax + "\n";
					richTextBox4->Text += "Ìèíèìàëüíûé øàã: " + hmin + ", ïðè x = " + xmin + "\n";
				};
...
{	
	...
	if (comboBox1->SelectedIndex == 1)
	{
		...
		label8->Hide();
		label9->Hide();
		richTextBox1->Text = "Îñíîâíàÿ çàäà÷à 1:\n" + "du/dx = u^2 / (1+x^2)^(1/3) + u - u^3 * sin(10x)\n" + "U(0) = U0";
		dataGridView2->Rows->Clear();
		dataGridView1->Rows->Clear();
		tabPage4->Text = "U0 = " + checkBox1->Text;
		tabPage5->Text = "U0 = " + checkBox2->Text;
	...
	if (comboBox1->SelectedIndex == 2)
	{
		...
		label8->Show();
		label9->Show();
		richTextBox1->Text = "Îñíîâíàÿ çàäà÷à 2:\n" + "d^2u/dx^2 + a(du/dx)^2 + bu = 0\n" + "U(0) = U0\n" + "U'(0) = U'0";
